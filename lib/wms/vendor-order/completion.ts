...
export interface VendorOrderCompletionScope { checkedAt: string; discontinued: VendorCompletionEvidence[]; reorders: VendorCompletionEvidence[]; routedVendorLineIds?: string[]; demandSources?: Array<{ skuId: string; createdAt: string; purchaseOrderNumbers: string[]; actualShortageQuantity: number; shortageDetails: Array<{ purchaseOrderNumber: string; shortageQuantity: number }> }> }
