...
function harness({queue=true,failAck=false,missing=false}={}) {
  ...
  const run={id:"WEEKLY-submit",snapshot:{rulesVersion:require("../lib/wms/weekly-work-types.ts").WEEKLY_RULES_VERSION,sourceToken:"s",couponItems:[],vendorItems:[]},reviews:{"123":{skuId:"123",decision:"discontinue",quantity:0,quantityConfirmed:false,vendorName:"",imageUrl:""}},revision:0,updatedAt:now,sentVendors:{},discontinueQueueRequestIds:queue?{"123":["request-1"]}:{}};
